...
toRPN=: 3 : 0 NB. reorder tokens into RPN sequence, no '(' ')' of course
  o=. 0$0 [ r=. 0$<0
  for_c. y do.
...
calcRPN=: 3 : 0
  ...
  (":s),' (#',((d2h=.'0123456789abcdef'{~16#.^:_1])<.{.s),')'
)

echo calcRPN (1!:2&2)toRPN parse >{:ARGV NB. e.g. 1+10*(100+1)-_200/(2^3/4) --> 1111
